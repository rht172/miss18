...
if (czGet('key1') == "update") {
    $select_Feilds = "tid,combo_sku,child_sku,child_qty,describition,created_on,created_by,last_updated_on";
...
<div class="container-fluid">
    <h1>Combo Master</h1><br>


    <form action="combo-ctrl.php?key1=<?php echo $processName; ?>" method="post" enctype="multipart/form-data">
        <div class="form-row">
            <div class="form-group   col-md-3">
                <label>Combo SKU</label>
                <input type="text" class="form-control" <?php echo 'value="' . $combo_sku . '"'; ?> id="combo_sku"
                    name="combo_sku" autofocus required>
            </div>

            <div class="form-group   col-md-3">
                <label>Child SKU</label>
                <input type="text" class="form-control" <?php echo 'value="' . $child_sku . '"'; ?> id = "child_sku" name = "child_sku">
            </div>

            <div class="form-group   col-md-3">
                <label>Child Qty</label>
                <input type="text" class="form-control" <?php echo 'value="' . $child_qty . '"'; ?> id = "child_qty" name = "child_qty">
            </div>
