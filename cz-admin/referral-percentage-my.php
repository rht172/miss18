  ...
  <div class="col-md-8">
    <table class="table table-striped ">
      ...
      <tbody id="myTable">
        ...
        $result = $obj_class_main->selectData_customqry("SELECT * FROM reward_points_factor_table where type = 'Referral';");

        //Loop Through Select Result
        while ($row = $result->fetch_assoc()) {
          echo "<tr>";
          echo "<td>" . $row['tid'] . "</td>";
          echo "<td>" . $row['reward_factor'] . "</td>";
        ?>
          <td><a href='referral-percentage-add.php?key1=update&updateKey=<?php echo $row['tid'] ?>' class='btn btn-success btn-sm' id='updateBtn'>Update</td>
        <?php
          echo "</tr>";
        }
        ?>
