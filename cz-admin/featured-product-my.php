...
<div class="container-fluid">
    <h1>My Featured product
        ...
        <a href="featured-product-add.php" class="btn btn-light btn-sm m-1 float-right" id="addBtn"><img
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','featured-product-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "featured-product-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    $(function () {
        $("#sku").autocomplete({
            source: 'auto-complete.php?type=sku&tbl=featured_product_table&tkn=' +
                tokenid
        });
    });
