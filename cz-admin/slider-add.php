...
if (czGet('key1') == "update") {
    $select_Feilds = "tid,slider_header,slider_header_2,slider_header_3,slider_button_url,created_on,created_by,last_updated_on,last_updated_by,ext_file,bg_color";
...
<div class="container-fluid">
    <h1>Slider Master</h1><br>


    <form action="slider-ctrl.php?key1=<?php echo $processName; ?>" method="post" enctype="multipart/form-data">
        <div class="form-row">
            ...
            <div class="form-group   col-md-3">
                ...
                <input type="text" class="form-control" <?php echo 'value="' . $bg_color . '"'; ?>
            ...
            if (strlen($ext_file) > 0) {
                ?>
                <div class="col-md-6">
                    <img src="attachments/slider/<?php echo 'tid-' . $tid ?>.<?php echo $ext_file ?>" alt="img"
                        class="img-thumbnail">
                </div>
                <?php
            }
...
<script>
    ...
    $(function () {
        $("#category").autocomplete({
            source: 'auto-complete.php?type=category&tbl=slider_table&tkn=' +
                tokenid
        });
    });
