...
if (czGet('key1') == "update") {
  ...
  $reward_factor = czPostForSQL('reward_factor');

  //Get Value to form Update Query
  $updateValueAndFeilds = "reward_factor = '$reward_factor',type = 'Referral'";
  ...
  if ($UpdateStatus == "Success") {
    header("Location: referral-percentage-my.php?key1=updateSuccess");
    exit();
  } else {
    header("Location: referral-percentage-my.php?key1=updateFailed");
    exit();
  }
}
