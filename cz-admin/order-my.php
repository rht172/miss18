...
<div class="container-fluid">
    ...
    <h1>Order
        ...
        <a href="order-add.php" class="btn btn-light btn-sm m-1 float-right"><img
    ...
    <div class="form-row">
        ...
        <div class="form-group   col-md-3">
            ...
            <input type="text" class="form-control" id="despatch_details" name="despatch_details">
        </div>
        ...
        <div class="form-group   col-md-3">
            ...
            <label for="created"> Order Date</label><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','order-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        var formData = {
            ...
            despatch_details: $('#despatch_details').val(),
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "order-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    const despatch_details = document.getElementById("despatch_details");
    const customer_id = document.getElementById("customer_id");
    const track_id = document.getElementById("track_id");
    const clearButton = document.getElementById("reset");

    clearButton.addEventListener("click", function () {
        order_status.value = "";
        despatch_details.value = "";
        customer_id.value = "";
        track_id.value = "";
