...
<div class="container-fluid">
    <div class="col-md-12 row p-0">
        ...
        <div class="col-md-6 p-0">
            ...
            <a href="top-selling-add.php" class="btn btn-light btn-sm m-1 float-right" id="addBtn"><img
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','top-selling-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "top-selling-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    $(function () {
        $("#sku").autocomplete({
            source: 'auto-complete.php?type=sku&tbl=top_selling_table&tkn=' +
                tokenid
        });
    });
