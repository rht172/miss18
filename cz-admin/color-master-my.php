...
<div class="container-fluid">
    ...
    <h1>MY Colors
        ...
        <a href="color-master-add.php" class="btn btn-light btn-sm m-1 float-right"><img
    ...
    <div class="form-row">
        ...
        <div class="form-group   col-md-3">
            ...
            <select class="form-control" id="color_name" name="color_name">
                <option value=""></option>
                <?php
                $result = $obj_class_main->selectData_customqry("select distinct color_name from color_master_table");
                while ($row = $result->fetch_assoc()) {
                    if ($color_name == $row['color_name']) {
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','color-master-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "color-master-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    $(function () {
        $("#color_name").autocomplete({
            source: 'auto-complete.php?type=color_name&tbl=color_master_table&tkn=' +
                tokenid
        });
    });
