...
if (czGet('key1') == "insert") {
    ...
    if (strlen($sku) > 0) {
        ...
        if ($insertStatus > 0) {
            header("Location: top-selling-my.php?key1=insertSuccess");
            exit();
        } else {
            header("Location: top-selling-my.php?key1=insertFailed");
            exit();
        }
    }
}
...
if (czGet('key1') == "update") {
    ...
    if ($UpdateStatus == "Success") {
        header("Location: top-selling-my.php?key1=updateSuccess");
        exit();
    } else {
        header("Location: top-selling-my.php?key1=updateFailed");
        exit();
    }
}
    ...
    <table class="table table-striped ">
        ...
        <tbody id="myTable">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                //Update Call
                echo "<td><a href='top-selling-add.php?key1=update&updateKey=" . $row['tid'] . "' class='btn btn-success btn-sm'>Update</td>";
