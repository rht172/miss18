...
<div class="container-fluid">
    ...
    <h1>Brand
        ...
        <a href="brand-add.php" class="btn btn-light btn-sm m-1 float-right"><img src="assets/icons/Theam1New.png"
    ...
    <div class="form-row">
        ...
        <div class="form-group   col-md-3">
            ...
            <select class="form-control" <?php echo 'value="' . $brand . '"'; ?> id="brand" name="brand">
                <option value=""></option>
                <?php
                $result = $obj_class_main->selectData_customqry("select distinct brand from ecom_brand_master");
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','brand-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "brand-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
