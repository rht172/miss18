...
<div class="container-fluid">
    ...
    <div class="col-md-12 row p-0">
        ...
        <div class="col-md-6 p-0">
            ...
            <a href="sub-slider-add.php" class="btn btn-light btn-sm m-1 float-right" id="addBtn"><img
    ...
    <div class="form-row">
        ...
        <div class="form-group   col-md-2">
            ...
            <input type="text" class="form-control" id="slider_header" name="slider_header">
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','sub-slider-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        var formData = {
            slider_header: $('#slider_header').val(),
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "sub-slider-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    $(function () {
        $("#slider_header").autocomplete({
            source: 'auto-complete.php?type=slider_header&tbl=sub_slider_table&tkn=' +
                tokenid
        });
    });
    ...
    // For clear filters
    const slider_header = document.getElementById("slider_header");
