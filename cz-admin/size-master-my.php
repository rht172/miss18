...
<div class="container-fluid">
    ...
    <h1>Size Master
        ...
        <a href="size-master-add.php" class="btn btn-light btn-sm m-1 float-right"><img
    ...
    <div class="form-row">
        ...
        <div class="form-group   col-md-3">
            ...
            <select class="form-control" id="size" name="size">
                <option value=""></option>
                <?php
                $result = $obj_class_main->selectData_customqry("select distinct size from size_table");
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','size-master-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "size-master-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
