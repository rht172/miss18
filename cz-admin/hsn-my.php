...
<div class="container-fluid">
    ...
    <h1>HSN
        ...
        <a href="hsn-add.php" class="btn btn-light btn-sm m-1 float-right"><img src="assets/icons/Theam1New.png"
    ...
    <div class="form-row">
        ...
        <div class="form-group   col-md-3">
            ...
            <select class="form-control" <?php echo 'value="' . $hsn . '"'; ?> id="hsn" name="hsn">
                <option value=""></option>
                <?php
                $result = $obj_class_main->selectData_customqry("select distinct hsn from ecom_hsn_table");
                while ($row = $result->fetch_assoc()) {
                    if ($hsn == $row['hsn']) {
                        echo ' <option selected="selected" value="' . $row['hsn'] . '" >' . $row['hsn'] . '</option>';
                    } else {
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','hsn-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "hsn-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    $(function () {
        $("#hsn").autocomplete({
            source: 'auto-complete.php?type=hsn&tbl=ecom_hsn_master&tkn=' +
                tokenid
        });
    });
