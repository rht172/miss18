...
<div class="container-fluid">
    ...
    <h1>Category
        ...
        <a href="category-add.php" class="btn btn-light btn-sm m-1 float-right"><img src="assets/icons/Theam1New.png"
    ...
    <div class="form-row">
        ...
        <div class="form-group   col-md-3">
            ...
            <select class="form-control" <?php echo 'value="' . $category . '"'; ?> id="category" name="category">
                <option value=""></option>
                <?php
                $result = $obj_class_main->selectData_customqry("select distinct category from ecom_category_master");
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "category-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
