...
<div class="container-fluid">
    ...
    <h1>City
        ...
        <a href="city-add.php" class="btn btn-light btn-sm m-1 float-right" id="addBtn"><img
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','city-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "city-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
