...
<div class="container-fluid">
    <h1>Sub Slider Master</h1><br>


    <form action="sub-slider-ctrl.php?key1=<?php echo $processName; ?>" method="post" enctype="multipart/form-data">
        <div class="form-row">
            <div class="form-group   col-md-3">
                <label>Slider Header</label>
                <input type="text" class="form-control" <?php echo 'value="' . $slider_header . '"'; ?>
                    id="slider_header" name="slider_header" autofocus required>
            </div>
            ...
            if (strlen($ext_file) > 0) {
                ?>
                <div class="col-md-6">
                    <img src="attachments/sub_slider/<?php echo 'tid-' . $tid ?>.<?php echo $ext_file ?>" alt="img"
                        class="img-thumbnail">
                </div>
                <?php
            }
