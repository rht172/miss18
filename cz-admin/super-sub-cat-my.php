...
<div class="container-fluid">
    ...
    <h1>Super Sub Category
        ...
        <a href="super-sub-cat-add.php" class="btn btn-light btn-sm m-1 float-right"><img
    ...
    <div class="form-row">
        <div class="form-group   col-md-3">
            ...
            <select class="form-control" <?php echo 'value="' . $super_sub_category . '"'; ?> id="super_sub_category"
                name="super_sub_category">
                <option value=""></option>
                <?php
                $result = $obj_class_main->selectData_customqry("select distinct super_sub_category from ecom_super_sub_category_master");
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','super-sub-cat-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "super-sub-cat-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    $(function () {
        $("#super_sub_category").autocomplete({
            source: 'auto-complete.php?type=super_sub_category&tbl=ecom_category_master&tkn=' +
                tokenid
        });
    });

    const super_sub_category = document.getElementById("super_sub_category");
    const clearButton = document.getElementById("reset");

    clearButton.addEventListener("click", function () {
        super_sub_category.value = "";
