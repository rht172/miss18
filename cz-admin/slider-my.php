...
<div class="container-fluid">
    ...
    <div class="col-md-12 row p-0">
        ...
        <div class="col-md-6 p-0">
            ...
            <a href="slider-add.php" class="btn btn-light btn-sm m-1 float-right" id="addBtn"><img
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="modelYesButton" type="button" class="btn btn-primary"
                    onclick="getCheckedValuesForDelete('myTable','#exampleModal','slider-ctrl.php?key1=delete','#filterTableBody')">yes</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadTableData(pageNo) {
        ...
        // Table Body ID, URL, 
        loadTableDataFromAjax("#filterTableBody", "slider-ctrl.php?key1=filter&pageNo=" + pageNo, formData);
    ...
    $(function () {
        $("#slider_header").autocomplete({
            source: 'auto-complete.php?type=slider_header&tbl=slider_table&tkn=' +
                tokenid
        });
    });
